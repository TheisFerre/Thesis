#!/bin/sh
#BSUB -J compute_losses #The name the job will get
...
#BSUB -W 2:00 #The maximum runtime my job have note that the queuing might enable shorter jobs earlier due to scheduling.
...
python /zhome/2b/7/117471/Thesis/src/models/performance_ablation.py
